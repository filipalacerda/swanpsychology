const PrivacyPolicy = () => {
  return (
    <section className="md:p-24 p-12 flex md:mt-20 mt-10 gap-20 md:flex-row flex-col mb-10">
      <div>
        <h2 className="text-3xl font-bold md:w-96">Privacy Policy</h2>
      </div>
      <div className="leading-10 text-md font-light">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Swan Psychology.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Swan Psychology, accessible
              from{" "}
              <a
        ...
        <h2 className="font-bold">Children&lsquo;s Privacy</h2>
        <p>
        ...
        <ul>
          <li>
            By email:{" "}
            <a href="mailto:SWANpsychology@proton.me" className="underline">
              SWANpsychology@proton.me
            </a>
          </li>
        </ul>
      </div>
