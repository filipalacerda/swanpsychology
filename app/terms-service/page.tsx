const TermsService = () => {
  return (
    <section className="md:p-24 p-12 flex md:mt-20 mt-10 gap-20 md:flex-row flex-col mb-10">
      <div>
        <h2 className="text-3xl font-bold md:w-96">Terms of Service</h2>
      </div>
      ...
      <div className="leading-10 text-md font-light">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to swanpsycholog.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to swanpsycholog, accessible from{" "}
              <a
                href="swanpsychology.co.uk"
                rel="external nofollow noopener"
                target="_blank"
                className="underline"
              >
                swanpsychology.co.uk
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: swanpsychology@proton.com</li>
        </ul>
      </div>
    </section>
  );
